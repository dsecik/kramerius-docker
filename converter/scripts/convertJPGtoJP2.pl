...
system("convert", "$inputFilePath", "-compress", "None", "$tempFilePath");

system("kdu_compress", "-i", "$tempFilePath", "-o", "$outputFilePath", "Cblk={64,64}", "Corder=RPCL", "ORGgen_plt=yes", "ORGtparts=R",
